...
export function Hero({ brands, models }: { brands: Brand[]; models: Model[] }) {
  ...
  return (
    <section className="relative flex items-center overflow-hidden bg-ink lg:min-h-[85vh]">
      ...
      <div className="relative z-[2] mx-auto grid w-full max-w-site items-start gap-4 px-[var(--gutter)] pt-8 pb-5 sm:gap-6 sm:pb-8 lg:gap-12 lg:pb-20 lg:grid-cols-2">
        ...
        <div className="order-3 lg:order-1">
          ...
          <div className="mb-4 hidden lg:block">
            <Image
              ...
              height={605}
              priority
              className="h-38 w-auto xl:h-86"
            />
          </div>

          <div className="hero-in mb-4 flex items-center gap-3">
          ...
          <h1 className="hero-in delay-1 mb-4 font-head font-black uppercase leading-none tracking-tight">
          ...
          <p className="hero-in delay-2 mb-5 max-w-md text-[15px] font-light leading-relaxed text-white/65">
            Thousands of <strong className="font-medium text-white/85">engine, body, brake & electrical</strong> parts in stock. Filter by your bike model and year see only what fits.
          </p>
        ...
        <div className="hero-in order-2 relative pt-0 lg:order-2 lg:pt-14">
          {/* Decorative gold star badge */}
          <div className="absolute -top-5 -right-4 z-10 hidden md:flex h-[90px] w-[90px] items-center justify-center bg-gold text-black shadow-[0_4px_20px_rgba(245,166,35,0.4)]"
               style={{ clipPath: "polygon(50% 0%,61% 35%,98% 35%,68% 57%,79% 91%,50% 70%,21% 91%,32% 57%,2% 35%,39% 35%)" }}>
            <span className="text-center font-head text-[8.5px] font-extrabold uppercase tracking-wide leading-tight">
              Free<br />Fitment<br />Advice
            </span>
          </div>
